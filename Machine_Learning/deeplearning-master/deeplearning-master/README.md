...
Si vous obtenez cette erreur, c'est que vous n'avez pas correctement configuré le "working directory" dans Spyder.

En utilisant le File Explorer, naviguez dans vos dossiers jusqu'à arriver dans votre projet de code, comme je fais à la fin de la vidéo "Construire un ANN - Étape 1".

Il faut bien double-cliquer sur le dossier qui sera le dossier de travail.
