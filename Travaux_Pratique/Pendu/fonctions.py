...
def recup_scores():
    ...
    existe.  Dans tous les cas, on renvoie un dictionnaire,  soit l'objet dépicklé,
    soit un dictionnaire vide. On s'appuie sur nom_fichier_scores défini dans donnees.py"""
...
def enregistrer_scores(scores):
    ...
    nom_fichier_scores. Elle reçoit en paramètre le dictionnaire des scores à enregistrer"""
...
def recup_nom_utilisateur():
    """Fonction chargée de récupérer le nom de l'utilisateur. Le nom de l'utilisateur doit être composé de 4 caractères minimum,
